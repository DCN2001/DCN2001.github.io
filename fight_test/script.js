...
const background = new Sprite({
 ...
 const player = new Fighter({    //創建主角
    ...
    color: 'red',
    imagesource: './img/knight_v1/idle.png',
    framesMax: 10,
    scale: 4.0,
    offset: {
        x: 200,      //人物初始位置(x, y)軸
    ...
    sprites:{
        ...
        run:{
            imagesource: './img/knight_v1/run.png',
            framesMax: 10
        },
        jump:{
            imagesource: './img/knight_v1/jump.png',
            framesMax: 3
        },
        fall:{
            imagesource: './img/knight_v1/fall.png',
            framesMax: 3
        },
        attack1:{
            imagesource: './img/knight_v1/attack.png',
            framesMax: 4  //attack_ 2:6
        },
        attack2:{
            imagesource: './img/knight_v1/attack3.png',
            framesMax: 10  //attack_ 2:6
        },
        takehit:{
            imagesource: './img/knight_v1/hit.png',
            framesMax: 1  
        },
        death:{
            imagesource: './img/knight_v1/death.png',
            framesMax: 10 
        }
    },
    attackbox:{
